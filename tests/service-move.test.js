/* 서비스 주소 이전(0-B, 2026-09-26) 검증 — minix-gongu-dashboard → minix-offlinepart-dashboard.
...
const OLD = 'minix-gongu-dashboard.onrender.com', NEW = 'https://minix-offlinepart-dashboard.onrender.com';
...
['minix-offlinepart-dashboard.onrender.com', 'localhost', '127.0.0.1', 'minix-workspace.onrender.com', 'gongu-dashboard.onrender.com'].forEach(h => {
...
console.log('\n[4] 이동 중엔 부트스트랩이 멈춤 — 세션이 있어도 옛 주소에서 진입하지 않음');
{
  ...
  const onNew = boot({ hostname: 'minix-offlinepart-dashboard.onrender.com', hash: '#calendar', localStorage: { gp_session: token } });
